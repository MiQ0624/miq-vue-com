<template>
  <div class="app-container">
    ...
    <el-dialog v-model="dictDataDialog.visible" :title="dictDataDialog.title" width="1000px" @close="closeDictDialog">
      ...
      <DictItem v-model:typeCode="selectedDictType.typeCode" v-model:typeName="selectedDictType.typeName" ></DictItem>
    </el-dialog>
  </div>
</template>
...
import DictItem from "@/views/system/components/dict-item.vue";
